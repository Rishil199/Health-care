    ...
    public function index(Request $request) {
        ...
        if ($request->ajax()) {
            ...
            if(Auth::user()->hasRole(['Receptionist'])){
                ...
                $doctors = DoctorDetails::with('user')->where('receptionist_id',$user_id->id)->orWhere('clinic_id',$user_id->clinic_id)->get();
                ...
                ->addColumn('action', function($row) {
                    $actionBtn =   '<div class="dropable-btn">
                                        <div class="dropdown">
                                            ...
                                            <li>
                                               <a class="dropdown-item doctor-view" href="javascript:void(0)" data-url="'. route('doctors.view',$row->id) .'" data-id="'. $row->id .'" data-bs-toggle="viewmodal" data-bs-target="#myViewModal">
                                                  <span class="svg-icon">
                                            ...
                                            <li>
                                               <a class="dropdown-item edit-doctor" href="javascript:void(0)" data-url="'. route('doctors.edit', $row->id) .'" data-id="'. $row->id .'">
                                                  <span class="svg-icon">
