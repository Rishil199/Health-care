                                ...
                                var table = $(document).find('.all-appointments-table').DataTable({
                                    ...
                                    columns: [
                                        ...
                                        { 'render': function(data, type, full, meta)
                                            {
                                                if ( full.next_date ) {
                                                    return  full.next_date + ' ' + full.next_start_time;
                                                }
            ...
            $.ajax({
                ...
                complete: function(response) {
                    ...
                    if ( resp ) {
                        ...
                        if ( resp.status ) {
                            make_view_modal( 'todays-appointment-details-modal theme-offcanvas-xl', resp.data.view, true );
                            if ( $(document).find('.todays-appointments-table').length ) {
                                var table = $(document).find('.todays-appointments-table').DataTable({
                                    processing: true,
                                    serverSide: true,
                                    aaSorting: [],
            ...
            $.ajax({
                ...
                complete: function(response) {
                    ...
                    if ( resp ) {
                        console.log('resp', resp)
                        if ( resp.status ) {
                            make_view_modal( 'upcoming-appointment-details-modal theme-offcanvas-xl', resp.data.view, true );
                            if ( $(document).find('.upcoming-appointments-table').length ) {
                                var table = $(document).find('.upcoming-appointments-table').DataTable({
                                    processing: true,
                                    serverSide: true,
                                    aaSorting: [],
            ...
            $.ajax({
                ...
                complete: function(response) {
                    ...
                    if ( resp ) {
                        console.log('resp', resp)
                        if ( resp.status ) {
                            make_view_modal( 'past-appointment-details-modal make_view_modal theme-offcanvas-xl', resp.data.view, true );
                ...
                $.ajax({
                    ...
                    success:function(response){
                        if(response.status){
                            ...
                            $(document).find('#todays-appointments-table').DataTable().ajax.reload();
                            $(document).find('#upcoming-appointments-table').DataTable().ajax.reload();
