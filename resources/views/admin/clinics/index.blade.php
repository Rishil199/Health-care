      ...
      <div class="col-12">
         <div class="title main-title title-btn">
            ...
            <div class="form-btns title-btn">
               <a href="javascript:void(0)" data-url="{{ route('clinics.createMainBranch') }}" class="add-main-branch" data-bs-toggle="addmodal" data-bs-target="#myAddModal">
               ...
               <span data-href="{{ route('clinics.exportCSV') }}" id="export" class="btn btn-back ms-3" onclick ="exportClinics (event.target);">Export</span>
            </div>
         </div>
      </div>
   </div>
...
@push('footer_js')
    <script type="text/javascript">
        ...
        let clinics_store_url = "{{ route('clinics.store') }}"
        let add_branch = '{{ route('clinics.add-branch') }}';
