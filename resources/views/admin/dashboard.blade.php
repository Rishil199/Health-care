                    ...
                    <div class="welcome-title">
                        <div class="wt-lower">
                            ...
                            @if (Auth::user()->hasRole(User::ROLE_CLINIC))
                                <p class="text-uppercase text-dark mb-3"><b>Hospital name : {{ Auth::user()->first_name }}
                                    </b></p>
                ...
                <div class="col-12">
                    <div class="welcome-block">
                        <div class="welcome-user">
                            <p class="text-uppercase text-light">Welcome to the
                                @isset($title)
                                    {{ $title }}
                                @endisset {{ Auth::user()->first_name == 'Super' ? ' Admin ' : Auth::user()->first_name }}
                            </p>
                    ...
                    <div class="doctors-data-block">
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-lg-9 doctors-data-right">
                                <div class="row">
                                    @if (Auth::user()->hasAnyRole([User::ROLE_SUPER_ADMIN, User::ROLE_CLINIC, User::ROLE_PATIENT]))
                                        <div class="col-md-4 mb-3">
                                            <div class="theme-card">
                                                <div class="theme-card-fig">
                                                    <span class="theme-card-fig-title">Doctors</span>
                                                    @if (Auth::user()->hasAnyRole([User::ROLE_SUPER_ADMIN, User::ROLE_CLINIC]))
                                                        <a
                                                            href="{{ route('doctors.index') }}"class="theme-card-fig-count text-black text-decoration-none">{{ count($doctors) }}</a>
                                                    @endif
                                                    @if (Auth::user()->hasRole(User::ROLE_PATIENT))
                                                        <a href="{{ route('doctorslisting.index') }}"
                                                            class="theme-card-fig-count text-black text-decoration-none">{{ count($doctors) }}</a>
                                                    @endif
                                                </div>
                                    ...
                                    @if (Auth::user()->hasAnyRole([User::ROLE_SUPER_ADMIN, User::ROLE_DOCTOR, User::ROLE_RECEPTIONIST]))
                                        <div class="col-md-4 mb-3">
                                            <div class="theme-card dark">
                                                <div class="theme-card-fig">
                                                    <span class="theme-card-fig-title">Patients</span>
                                                    <a href="{{ route('patients.index') }}"
                                                        class="theme-card-fig-count text-decoration-none">{{ count($patients) }}</a>
                                                </div>
                                                <span class="link-circle"></span>
                                            </div>
                                        </div>
                                    ...
                                    @if (Auth::user()->hasAnyRole([User::ROLE_SUPER_ADMIN, User::ROLE_CLINIC]))
                                        <div class="col-md-4 mb-3">
                                            <div class="theme-card ">
                                                <div class="theme-card-fig">
                                                    <span class="theme-card-fig-title">Staff</span>
                                                    <a href="{{ route('receptionists.index') }}"
                                                        class="theme-card-fig-count text-black text-decoration-none">{{ $receptionistCount }}</a>
                                                </div>
                                                <span class="link-circle"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="latest-user-block theme-block">
                                        ...
                                        <div class="theme-tab">
                                            <ul class="nav nav-tabs" id="latestUserTab" role="tablist">
                                                @if (Auth::user()->hasAnyRole([User::ROLE_SUPER_ADMIN, User::ROLE_PATIENT, User::ROLE_DOCTOR, User::ROLE_RECEPTIONIST]))
                                                    <li class="nav-item" role="presentation">
                                                        <button class="btn active" id="doc-tab" data-bs-toggle="tab"
                                                            data-bs-target="#doc-tab-pane" type="button" role="tab"
                                                            aria-controls="doc-tab-pane" aria-selected="true">
                                                            <span class="svg-icon">
                                                                <svg version="1.1" class="me-2" width="26"
                                                                    id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                                                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                                                                    y="0px" viewBox="0 0 384 384"
                                                                    style="enable-background:new 0 0 384 384;"
                                                                    xml:space="preserve">
                                                                    <g>
                                                                        <path
                                                                            d="M74.3,40c0-4.7,0-8.8,0-12.9c0-3.1,1.1-5.2,4.3-5.5c2.8-0.3,4.6,2,4.7,5.5c0.1,4.1,0,8.2,0,12.6c12.7,0,25.3,0,38.3,0
                                                                        ...
                                                                        <path
                                                                            d="M81.9,254.7c-16.9,0-30.5-13.6-30.5-30.5c0-16.9,13.7-30.5,30.5-30.5c16.9,0,30.5,13.7,30.5,30.5
                                                                            ...
                                                                            fill="#fff"></path>
                                                                        <path
                                                                            d="M81.8,329.7c-16.9-0.1-30.5-13.7-30.4-30.6c0.1-16.9,13.8-30.4,30.6-30.4c16.8,0.1,30.4,13.7,30.4,30.6
                                                                        ...
                                                                        <path
                                                                            d="M164.3,160c-9.6,0-19.2,0-28.8,0c-4.4,0-7-3.7-4.7-6.7c0.9-1.2,2.9-2.2,4.4-2.2c19.6-0.1,39.2-0.1,58.8-0.1
                                                                                        c2.9,0,4.9,1.4,4.9,4.5c0,3.1-2,4.5-4.9,4.5C184,160,174.2,160,164.3,160z"
                                                                            fill="#fff"></path>
                                                                        <path
                                                                            d="M164.6,226c9.5,0,19,0,28.5,0c3.1,0,5.5,0.9,5.7,4.4c0.2,3-1.9,4.6-5.9,4.6c-19,0-38,0-56.9,0c-2.7,0-5-0.5-5.9-3.5
                                                                                        c-0.9-3,1.4-5.5,5.3-5.5C145.1,226,154.8,226,164.6,226z"
                                                                            fill="#fff"></path>
                                                                        <path
                                                                            d="M49.5,116.7c0,6.9,0,13.7,0,20.6c0,3.7-1.6,5.6-4.5,5.6c-2.9,0-4.4-1.9-4.5-5.7c0-13.6,0-27.2,0-40.8
                                                                        ...
                                                                        <path
                                                                            d="M78.2,149.9c3.9-3.7,6.9-6.5,9.8-9.4c2.2-2.2,4.6-3.1,7.2-0.7c2.1,2,1.8,4.5-0.8,7.1c-3.8,3.7-7.7,7.4-11.6,11.1
                                                                        ...
                                                                        <path d="M78.7,224.5c3.5-3.4,6.5-6.2,9.5-9c2.7-2.5,5.2-2.8,7.1-0.6c2.3,2.7,1.2,5-1,7.1c-3.9,3.7-7.7,7.4-11.6,11.1
                                                                                        ...
                                                                                        z" fill="#fff"></path>
                                                                        <path
                                                                            d="M78.5,299.7c3.7-3.5,6.6-6.3,9.6-9.1c2.2-2.2,4.6-3.1,7.2-0.7c2.1,2,1.9,4.5-0.8,7.1c-3.8,3.7-7.7,7.4-11.6,11.1
                                                ...
                                                @if (Auth::user()->hasAnyRole([User::ROLE_SUPER_ADMIN, User::ROLE_PATIENT]))
                                                    <li class="nav-item" role="presentation">
                                                        <button class="btn" id="recipt-tab" data-bs-toggle="tab"
                                                            data-bs-target="#recipt-tab-pane" type="button"
                                                            role="tab" aria-controls="recipt-tab-pane"
                                                            aria-selected="false">
                                                            <span class="svg-icon">
                                                                <svg width="26" class="me-2"
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                    version="1.1" id="Layer_1" x="0px" y="0px"
                                                                    viewBox="0 0 520.9 504.1"
                                                                    style="enable-background:new 0 0 520.9 504.1;"
                                                                    xml:space="preserve">
                                                                    <style type="text/css">
                                                                        .st0 {
                                                                            fill: #fff;
                                                ...
                                                @elseif(Auth::user()->hasRole(User::ROLE_CLINIC))
                                                    <li class="nav-item" role="presentation">
                                                        <button class="btn {{ $doctors->isEmpty() ? 'active' : '' }} mb-2"
                                                            id="recipt-tab" data-bs-toggle="tab"
                                                            data-bs-target="#recipt-tab-pane" type="button"
                                                            role="tab" aria-controls="recipt-tab-pane"
                                                            aria-selected="{{ $doctors->isEmpty() ? 'true' : 'false' }}">
                                                            <span class="svg-icon">
                                                                <svg width="26" class="me-2"
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                                                ...
                                                @if (Auth::user()->hasAnyRole([User::ROLE_SUPER_ADMIN, User::ROLE_DOCTOR, User::ROLE_RECEPTIONIST]))
                                                    <li class="nav-item" role="presentation">
                                                        <button class="btn" id="patient-tab" data-bs-toggle="tab"
                                                            data-bs-target="#patient-tab-pane" type="button"
                                                            role="tab" aria-controls="patient-tab-pane"
                                                            aria-selected="false">
                                                            <span class="svg-icon">
                                                                <svg width="26" class="me-2"
                                                                    xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            @if (Auth::user()->hasAnyRole([
                                                ...
                                                @elseif (Auth::user()->hasAnyRole(User::ROLE_PATIENT))
                                                    <div class="tab-content" id="latestUserTabContent">
                                                        <div class="tab-pane fade show active" id="doc-tab-pane"
                                                            role="tabpanel" aria-labelledby="doc-tab" tabindex="0">
                                                            <div class="table-responsive">
                                            ...
                                            @else
                                                <div class="tab-pane fade {{ Auth::user()->hasRole(User::ROLE_CLINIC) && $doctors->isEmpty() ? 'show active' : '' }}"
                                                    id="recipt-tab-pane" role="tabpanel" aria-labelledby="recipt-tab"
                                                    tabindex="0">
                                                    <div class="table-responsive">
                                                        <table class="table theme-table sr-table">
                                                            <thead class="table-dark">
