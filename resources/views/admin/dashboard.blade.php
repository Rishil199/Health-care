                                        ...
                                        <div class="col-lg-12 col-sm-4">
                                            <div class="doc-data-card doctor">
                                                <div class="doc-data-img"><img
                                                        src="{{ asset('assets/img/stethoscope.svg') }}" alt="">
                                                </div>
                                                <div class="doc-data">
                                    ...
                                    @if (Auth::user()->hasAnyRole([User::ROLE_SUPER_ADMIN, User::ROLE_DOCTOR, User::ROLE_RECEPTIONIST]))
                                        <div class="col-lg-12 col-sm-4">
                                            <div class="doc-data-card patient">
                                                <div class="doc-data-img"><img
                                                        src="{{ asset('assets/img/examination.svg') }}" alt="">
                                                </div>
                                                <div class="doc-data">
                                                    <div class="doc-data-count">
                                    ...
                                    @if (Auth::user()->hasAnyRole([User::ROLE_SUPER_ADMIN, User::ROLE_CLINIC]))
                                        <div class="col-lg-12 col-sm-4">
                                            <div class="doc-data-card receptionist">
                                                <div class="doc-data-img"><img
                                                        src="{{ asset('assets/img/receptionist.svg') }}" alt="">
                                                </div>
                                                <div class="doc-data">
                                                    <div class="doc-data-count">
                                                        <a
                                                            href="{{ route('receptionists.index') }}">{{ $receptionistCount }}</a>
                                                    </div>
                                    ...
                                    <div class="theme-tab">
                                        <ul class="nav nav-tabs" id="latestUserTab" role="tablist">
                                            ...
                                            @if (Auth::user()->hasAnyRole([User::ROLE_SUPER_ADMIN, User::ROLE_PATIENT]))
                                                <li class="nav-item" role="presentation">
                                                    <button class="btn" id="recipt-tab" data-bs-toggle="tab"
                                                        ...
                                                        aria-controls="recipt-tab-pane" aria-selected="false">
                                                        <span class="svg-icon">
                                                            <svg width="26" class="me-2"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                                id="Layer_1" x="0px" y="0px" viewBox="0 0 520.9 504.1"
                                            ...
                                            @elseif(Auth::user()->hasRole(User::ROLE_CLINIC))
                                                <li class="nav-item" role="presentation">
                                                    <button class="btn {{ $doctors->isEmpty() ? 'active' : '' }}"
                                                        id="recipt-tab" data-bs-toggle="tab"
                                                        data-bs-target="#recipt-tab-pane" type="button" role="tab"
                                                        aria-controls="recipt-tab-pane"
                                            ...
                                            @if (Auth::user()->hasAnyRole([User::ROLE_SUPER_ADMIN, User::ROLE_DOCTOR, User::ROLE_RECEPTIONIST]))
                                                <li class="nav-item" role="presentation">
                                                    <button class="btn" id="patient-tab" data-bs-toggle="tab"
                                                        ...
                                                        aria-controls="patient-tab-pane" aria-selected="false">
                                                        <span class="svg-icon">
                                                            <svg width="26" class="me-2"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
