            ...
            <div class="col-12">
                <div class="title main-title title-btn">
                    ...
                    <div class="form-btns title-btn">
                        <a href="javascript:void(0)" data-url="{{ route('doctors.create') }}" class="btn-add-doctors"
                            data-bs-toggle="addmodal" data-bs-target="#myAddModal" id="btn-add-doctors">
                            <button class="btn btn-back ripple-hover plus">
                                <span class="svg-icon me-2">
                                    <svg fill="#fff" width="18" version="1.1" id="lni_lni-plus"
                        ...
                        <span data-href="{{ route('doctors.exportCSV') }}" id="export" class="btn btn-back ms-3"
                            onclick ="exportDocotrs (event.target);">Export</span>
                    </div>
                </div>
            </div>
        </div>
