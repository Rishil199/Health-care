<div class="modal-content">
    ...
    <div class="modal-body">
        <form action="{{ route('roles.store') }}" method="post" class="add_role_form" id="add_role_form" autocomplete="off">
            @csrf
            <div class="row">
                <div class="col-md-12 mb-3">
                    <div class="form-group theme-form-group">
                        ...
                        <div class="theme-form-input">
                            <input class="form-control" id="name" name="name" type="text" placeholder="Role Name" required />
                        </div>
                        @error('name')
                ...
                <div class="col-md-12 mb-3">
                    <div class="form-group theme-form-group">
                        <label class="theme-label" for="permission" class="permission">Permissions <span class="text-danger">* </label>
                            <div class="theme-form-input">
                                <div class="row">
                                    @foreach($permission as $value)
                                        <div class="col-3">
                                            <div class="custom-control custom-checkbox">
                                                <div class="theme-form-input">
                                                    <input class="custom-control-input permissions" type="checkbox" name="permission[]" id="permission-{{ $value->id }}" value="{{ $value->id }}" />
                                                </div>
                        ...
                        <div class="modal-footer justify-content-center">
                            <button type="submit" value="Add" name="add_roles" id="validation-next" class="btn btn-back mt-4 btn-add-role">
